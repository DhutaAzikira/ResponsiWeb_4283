    ...
    <nav class="bg-white">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-dark">PT Dhuta Wacana</span>
            </a>
        ...
        <div class="py-1 px-4 mx-auto max-w-screen-xl  lg:py-16 grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div class="flex flex-col justify-center">
                <h1
                    ...
                    daw</h1>
                <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400">dwa</p>
            ...
            <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                <div class="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
                    ...
                    <div class="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
                        <a href="/">
                            <i class="bx bxl-facebook-square text-2xl text-primary hover:text-yellow">Dhuta Azikira</i>
                        </a>
                        <a href="/" class="pl-4">
